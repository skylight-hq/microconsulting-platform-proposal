...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>All information provided herein is licensed under the <a href="https://creativecommons.org/publicdomain/zero/1.0/">Creative Commons Universal Public Domain Dedication</a>.</td>
    </tr>
    <tr>
      <td><strong>Recipient Agencies</strong></td>
      <td>
...
In alignment with the [U.S. Digital Services Playbook](https://playbook.cio.gov/), we intend to integrate proven practices from various digital delivery disciplines. Effective use of these multi-disciplinary practices &mdash; in an integrated fashion &mdash; yield products that are highly valuable, adaptable, reliable, timely, and cost-efficient.

<table>
  <thead>
    <tr>
      <th><strong>Digital Delivery Discipline</strong></th>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
          ...
          <li>Style guide</li>
          <li>Design pattern library</li>
          <li>Participatory design (e.g., design studio)</li>
          <li>Wireframing</li>
          <li>Prototyping</li>
          <li>Mockuping</li>
    ...
    <tr>
      ...
      <td>Business needs analysis</td>
    </tr>
    <tr>
      <td>Product management</td>
      <td>
        <ul>
          <li>Lean validation</li>
          <li>Product visioning</li>
          <li>Product roadmapping</li>
          <li>Story writing, prioritization, and estimation (e.g., user stories, technical stories)</li>
          <li>Minimum viable product</li>
          <li>Release planning and monitoring</li>
          <li>Iteration planning and monitoring</li>
          <li>Product backlog management</li>
          <li>Performance measurement</li>
          <li>Visual controls</li>
          <li>Scrum framework with two-week iteration cycles</li>
          <li>User growth</li>
        </ul>
      </td>
    </tr>
...
* **Fullstack Engineer.** Responsible for creating a usable, adaptable, reliable, and secure product, leveraging expertise in system architecture, frontend development, backend development, agile software development practices and tools, DevOps practices and tools, open source software, APIs, cloud computing, microservices, federal security standards, and Section 508 compliance.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Make the product available to all users, and operate and maintain with the goal of continuously improving</td>
    </tr>
  </tbody>
</table>
...
* Create the space for creative and innovative thinking through [liberating-structure exercises](http://www.liberatingstructures.com/) such as [TRIZ](http://www.liberatingstructures.com/6-making-space-with-triz/).
...
<table>
  ...
  <tbody>
    <tr>
      <td>Kickoff Phase Plan</td>
      <td>3 business days from date of contract award </td>
      <td>See Section 2.4.3.1.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>End of each week</td>
      <td>See Section 2.4.6.</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>At the conclusion of the contract</td>
      <td>All assets produced over the course of the project, including source code repository</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        <ul>
          <li>Over 20 years of technology and management experience</li>
    ...
    <tr>
      ...
      <td>Sean Johnson (Skylight)</td>
      <td>
        <ul>
          <li>Over 20 years of product management and engineering experience</li>
          <li>Built and exited two tech startups, including a 2011 TechCrunch Disrupt Runner-up called TalkTo</li>
          <li>Recently launched Carrot, an open-source, digital transparency platform for organizations</li>
          <li>Holds a Bachelor of Science in computer science from Clemson University</li>
        </ul>
      </td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td>Kin Lane (Skylight)</td>
      <td>
        <ul>
          <li>Nearly 20 years of engineering experience</li>
          <li>World-recognized expert in API-based application design and implementation</li>
          <li>Served as a White House Presidential Innovation Fellow in 2013</li>
        </ul>
      </td>
    </tr>
...
The recommended contract type is time & materials (T&M), [which is appropriate](https://www.excella.com/insights/fixed-price-vs-time-and-materials-better-software-development-contract-type) given the uncertain nature of the scope of work. The government may wish to pair the T&M contract with a not-to-exceed ceiling and fixed delivery timeframe. In effect, the government would be acquiring a fixed team for a fixed period of time. The scope would be bounded by a product vision statement, and the government product owner would direct the efforts of the team to produce the most valuable product with the given resources and the given amount of time.

Our proposed approach provides the government immediate and frequent visibility into contract performance. If the government is unsatisfied for any reason, it always reserves the right to [terminate for convenience](https://www.acquisition.gov/far/html/Subpart%2049_5.html).
...
<table>
  ...
  <tbody>
    <tr>
      <td>Base</td>
      <td>Kickoff, Discovery, Framing, Alpha</td>
      <td>3 months</td>
    </tr>
    <tr>
      <td>Option 1</td>
...
The following Skylight case studies highlight our ability to deliver successful digital products and platforms: [TalkTo](https://skylight.digital/work/talkto/), [Carrot](https://skylight.digital/work/carrot/), and [Maalka](https://skylight.digital/work/maalka/). These examples are highly relevant, particularly in terms of the modern digital delivery practices and technologies employed.
